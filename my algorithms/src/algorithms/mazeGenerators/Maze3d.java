...
public class Maze3d {
	...
	public byte[] toByteArray(){
		...
		mazeSettings[index] = (byte) this.rows;
		index++;
		mazeSettings[index] = (byte) this.cols;
		index++;
		mazeSettings[index] = (byte) this.levels;
		index++;
		mazeSettings[index] = (byte) this.startPosition.x;
		index++;
		mazeSettings[index] = (byte) this.startPosition.z;
		index++;
		mazeSettings[index] = (byte) this.startPosition.y;
		index++;
		mazeSettings[index] = (byte) this.goalPosition.x;
		index++;
		mazeSettings[index] = (byte) this.goalPosition.z;
		index++;
		mazeSettings[index] = (byte) this.goalPosition.y;
		index++;
	...
	public boolean equals(Maze3d m) {
			if(this.rows==m.rows && this.cols==m.cols && this.levels==m.levels && this.startPosition.equals(m.startPosition) && this.goalPosition.equals(m.goalPosition) && this.maze3d.equals(m.maze3d)){
				return true;
			}
			else
				return false;
